      ...
      <div class="row">
          <div class="col-xl-3">
                  ...
                  <div class="card-body">
                      <ul class="nav flex-column gap-1 nav-pills tab-style-7" role="tablist">
                          <li class="nav-item me-0" role="presentation">
                              <a class="nav-link d-inline-flex w-100 mb-2  bg-light active" id="account" data-bs-toggle="tab" role="tab"
                                  data-bs-target="#account-pane" href="#personal-info"
                              >Account Setting
                              </a>
                          </li>
                          <li class="nav-item me-0" role="presentation">
                              <a class="nav-link bg-light d-inline-flex w-100 mb-2" id="notification-tab" data-bs-toggle="tab"
                                  data-bs-target="#notification-tab-pane"  role="tab"
                                  aria-controls="notification-tab-pane" href="#personal-info"
                              >Notification</a>
                          </li>
                          <li class="nav-item me-0" role="presentation">
                              <a class="nav-link bg-light  d-inline-flex w-100 mb-0" id="security-tab" data-bs-toggle="tab"
                                  data-bs-target="#security-tab-pane"  role="tab"
                                  aria-controls="security-tab-pane" aria-selected="false"
                                  href="#personal-info">Security</a>
                          </li>
                      </ul>
                  </div>
              </div>
              <div class="card custom-card">
                  ...
                  <div class="card-body">
                      <div class="row gy-3">
                          <div class="col-xl-12"> <label for="Current-Password" class="form-label">Current
                                  Password :</label> <input type="text" class="form-control"
                                  id="Current-Password" placeholder="Enter Password..."> </div>
                          <div class="col-xl-12"> <label for="New-Password" class="form-label">New Password
                                  :</label> <input type="text" class="form-control" id="New-Password"
                                  placeholder="Enter Password..."> </div>
                          <div class="col-xl-12"> <label for="Confirm-Password" class="form-label">Confirm
                                  Password :</label> <input type="text" class="form-control"
                                  id="Confirm-Password" placeholder="Enter Password..."> </div>
                      </div>
                  </div>
                  <div class="card-footer text-end"> <a href="javascript:void(0);"
                          class="btn btn-primary btn-wave waves-effect waves-light"> Update </a> </div>
              </div>
          </div>
          <div class="col-xl-9">
              <div class="card custom-card">
                  <div class="p-3 border-bottom border-top border-block-end-dashed tab-content">
                      <div class="tab-pane show active overflow-hidden p-0 border-0" id="account-pane"
                          ...
                          <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-1">
                              <div class="fw-semibold d-block fs-15">Account Settings :</div>
                              <div class="btn btn-primary btn-sm"><i
                                      class="ri-loop-left-line lh-1 me-2"></i>Restore Changes</div>
                          </div>
                          <div class="row gy-3">
                              <div class="col-xl-12">
                                  <div class="d-flex align-items-start flex-wrap gap-3">
                                      ...
                                      <div>
                                          ...
                                          <span class="d-block fs-12 text-muted">Use JPEG, PNG, or GIF. Best
                                              size: 200x200 pixels. Keep it under 5MB</span>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-xl-6">
                              ...
                              <div class="col-xl-6">
                                  ...
                                  <input type="text" class="form-control bg-light" id="website"
                                      placeholder="https://" value="https://www.website.com">
                              </div>
                              <div class="col-xl-12">
                                  <label for="profile-address" class="form-label">Address :</label>
                                  <textarea class="form-control" id="profile-address" rows="3"
                                      placeholder="Address"></textarea>
                              </div>
                          </div>
                      </div>
                      <div class="tab-pane overflow-hidden p-0 border-0" id="notification-tab-pane"
                          ...
                          <div class="row gx-5 gy-3">
                              <div class="col-xl-12">
                                  ...
                                  <p class="fs-12 mb-0 text-muted">Users can tailor their experience to
                                      receive alerts for the types of events that matter to them.</p>
                              </div>
                              <div class="col-xl-12">
                                  <div class="d-flex align-items-top justify-content-between mt-3">
                                      <div class="mail-notification-settings">
                                          ...
                                          <p class="fs-12 mb-0 text-muted">Alerts sent to the user's mobile
                                              device or desktop.</p>
                                      </div>
                                  ...
                                  <div class="d-flex align-items-top justify-content-between mt-3">
                                      <div class="mail-notification-settings">
                                          ...
                                          <p class="fs-12 mb-0 text-muted">Messages sent to the user's email
                                              address.</p>
                                      </div>
                                  ...
                                  <div class="d-flex align-items-top justify-content-between mt-3">
                                      <div class="mail-notification-settings">
                                          ...
                                          <p class="fs-12 mb-0 text-muted">Alerts that appear within the
                                  ...
                                  <div class="d-flex align-items-top justify-content-between mt-3">
                                      <div class="mail-notification-settings">
                                          ...
                                          <p class="fs-12 mb-0 text-muted">Text messages sent to the user's
                                              mobile phone.</p>
                                      </div>
                      ...
                      <div class="tab-pane overflow-hidden p-0 border-0" id="security-tab-pane"
                          ...
                          <div class="d-sm-flex d-block align-items-top justify-content-between">
                              <div class="w-50">
                                  ...
                                  <p class="fs-12 mb-0 text-muted">Control how your profile information is
                                      verified for security purposes.</p>
                              </div>
                          ...
                          <div class="d-sm-flex d-block align-items-top justify-content-between mt-3">
                              <div class="w-50">
                                  ...
                                  <p class="fs-12 mb-0 text-muted">This helps protect accounts from
                                      unauthorized access, even if a password is compromised.</p>
                              </div>
                              <a href="javascript:void(0);" class="link-primary text-decoration-underline">Set
                                  Up Verification</a>
                          </div>
                          <div class="d-sm-flex d-block align-items-top justify-content-between mt-3">
                              <div class="w-50">
                                  <p class="fs-14 mb-1 fw-medium">Password Verification</p>
                                  <p class="fs-12 mb-0 text-muted">This additional step helps ensure that the
                                      person attempting to modify account details is the legitimate account
                                      owner.</p>
                              </div>
                              <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value=""
                  ...
                  <div class="card-footer border-top-0">
                      <div class="btn-list float-end">
                          <button class="btn btn-secondary btn-wave">Deactivate Account</button>
