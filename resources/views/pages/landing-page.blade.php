...
<head>
    ...
    <script>
        if (localStorage.zynixlandingdarktheme) {
            document.querySelector("html").setAttribute("data-theme-mode", "dark")
        }
        if (localStorage.zynixlandingrtl) {
                ...
                <div class="main-sidebar">
                    ...
                    <nav class="main-menu-container nav nav-pills sub-open">
                        <div class="landing-logo-container">
                            <div class="horizontal-logo">
                                <a href="index.html" class="header-logo">
                                    <img src="../assets/images/brand-logos/logo-ligal.png" alt="logo"
                                        class="desktop-logo">
                                    <img src="../assets/images/brand-logos/logo-ligal.png" alt="logo"
                                        class="desktop-dark">
                                </a>
                    ...
                    <div class="container main-banner-container pb-lg-0">
                        <div class="row">
                            <div class="col-xxl-8 col-xl-7 col-lg-7 col-md-8">
                                <div class="pt-lg-5">
                                    <div class="mb-3">
                                        <h6 class="fw-medium text-fixed-white op-9">Streamlined and Inclusive</h6>
                                    </div>
                                    <p class="landing-banner-heading mb-3 text-fixed-white fw-semibold">Streamlined Design, Intuitively Functional Discover the <span class="text-warning">Zynix</span> Template</p>
                                    <div class="fs-16 mb-5 text-fixed-white op-7">Experience seamless management with an admin template designed for optimal efficiency, featuring a sleek and contemporary interface that enhances task performance.</div>
                                    <a href="index.html" class="m-1 btn btn-lg bg-success text-fixed-white">
                                        View Demos
            ...
            <section class="section pt-5" id="about">
                <div class="container position-relative">
                    <div class="text-center">
                        ...
                        <h3 class="fw-semibold mb-2 mt-3">Why Opt for Our Services?</h3>
                    ...
                    <div class="row gx-5 mx-0">
                        <div class="col-xl-5">
                            <div class="home-proving-image d-none d-xl-block">
                                <img src="../assets/images/media/media-79.png" alt="" class="img-fluid] about-image">
                            </div>
                        ...
                        <div class="col-xl-7 my-auto">
                            <div class="heading-section text-start mb-4">
                                ...
                                <div class="heading-description fs-16 text-muted">Welcome to Zynix, where we provide a unique and personalized experience designed to surpass your expectations. Choose us and discover what true excellence looks like.</div>
                            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            <div class="heading-section text-center mb-0">
                                <span class="landing-text-heading dark-text">Features</span>
                                <h3 class="text-fixed-white text-center mt-3 fw-medium">Exceptional Features</h3>
                                <div class="fs-16 text-fixed-white text-center op-8">offers unparalleled capabilities designed to meet global standards. With cutting-edge technology, innovative tools, and seamless integration.</div>
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-primary-transparent avatar-rounded mb-3 border border-5 border-primary border-opacity-10">
                                            <img src="../assets/images/faces/team/1.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                                            <h5 class="mb-0 fw-medium">Mason Wallace</h5>
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-secondary-transparent avatar-rounded mb-3  border border-5 border-secondary border-opacity-10">
                                            <img src="../assets/images/faces/team/2.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                                            <h5 class="mb-0 fw-medium">Henry Morgan</h5>
                                            <p class="mb-1 fs-14 fw-medium text-secondary">Team Lead</p>
                                            <p class="mb-0 fs-13 text-muted op-8">Aliquam ullamcorper neque vitae dui
                                                ullamcorper, at varius erat feugiat. Proin aliquam, purus ut.</p>
                                                <div class="d-flex justify-content-center mt-3">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-primary btn-wave waves-effect waves-light"><i class="ri-twitter-x-fill"></i></a>
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-success-transparent avatar-rounded mb-3 border border-5 border-success border-opacity-10">
                                            <img src="../assets/images/faces/team/3.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                                            <h5 class="mb-0 fw-medium">Lucas Hayes</h5>
                                            <p class="mb-1 fs-14 fw-medium text-success">HR Manager</p>
                                            <p class="mb-0 fs-13 text-muted op-8">Aliquam ullamcorper neque vitae dui
                                                ullamcorper, at varius erat feugiat. Proin aliquam, purus ut.</p>
                                                <div class="d-flex justify-content-center mt-3">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-primary btn-wave waves-effect waves-light"><i class="ri-twitter-x-fill"></i></a>
                            ...
                            <div class="card custom-card team-member">
                                <div class="card-body text-center p-4">
                                        <span class="avatar avatar-xxl bg-info-transparent avatar-rounded mb-3 border border-5 border-info border-opacity-10">
                                            <img src="../assets/images/faces/team/4.png" class="card-img" alt="...">
                                        </span>
                                        <div class="text-center py-2">
                                            <h5 class="mb-0 fw-medium">Chloe Lewis</h5>
                                            <p class="mb-1 fs-14 fw-medium text-info">Director</p>
                                            <p class="mb-0 fs-13 text-muted op-8">Aliquam ullamcorper neque vitae dui
                                                ullamcorper, at varius erat feugiat. Proin aliquam, purus ut.</p>
                                                <div class="d-flex justify-content-center mt-3">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-primary btn-wave waves-effect waves-light"><i class="ri-twitter-x-fill"></i></a>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex gap-3 align-items-center p-1">
                                        ...
                                        <div class="text-start">
                                            <h4 class="fw-medium mb-1">Basic</h4> <span class="mb-1 text-muted d-block">Essential features for a magical
                                                start</span>
                                        </div>
                                    </div>
                                    <hr class="border-top my-4">
                                    <div>
                                        <h2 class="mb-0 fw-semibold d-block">$9.99/<span class="fs-12 fw-medium ms-1">Per Month</span></h2> <span class="text-muted fs-14"><span class="me-2 fw-semibold">+20/</span>Person Per month</span>
                                    </div>
                            ...
                            <div class="card custom-card pricing-card pricing-card1 border shadow-xs">
                                <div class="card-body p-4">
                                    <div class="d-flex gap-3 align-items-center p-1">
                                        ...
                                        <div class="text-start">
                                            <h4 class="fw-medium mb-1">Pro</h4> <span class="mb-1 text-muted d-block">Essential
                                                features for a magical start</span>
                                        </div>
                                    </div>
                                    <hr class="border-top my-4">
                                    <div>
                                        <h2 class="mb-0 fw-semibold d-block ">$19.99/<span class="fs-12  fw-medium ms-1">Per Month</span></h2> <span class="text-muted fs-14"><span class=" me-2 fw-semibold">+20/</span>Person Per month</span>
                                    </div>
                                    <div class="text-center my-3 pricing-barrier">
                            ...
                            <div class="card custom-card pricing-card pricing-card1 border shadow-xs">
                                <div class="card-body p-4">
                                    <div class="d-flex gap-3 align-items-center p-1">
                                        ...
                                        <div class="text-start">
                                            <h4 class="fw-medium mb-1">Premium</h4> <span class="mb-1 text-muted d-block">Pinnacle excellence, VIP support.</span>
                                        </div>
                                    </div>
                                    <hr class="border-top my-4">
                                    <div>
                                        <h2 class="mb-0 fw-semibold d-block ">$29.99/<span class="fs-12  fw-medium ms-1">Per Month</span></h2> <span class="text-muted fs-14"><span class=" me-2 fw-semibold">+20/</span>Person Per month</span>
                                    </div>
                                    <div class="text-center my-3 pricing-barrier">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 pe-0">
                                <div class="p-5 landing-contact-info">
                                    <div class="">
                                        ...
                                        <div class="mb-3 text-default"> <i class="ri-map-pin-fill me-2 text-muted"></i> 1352/A-12,
