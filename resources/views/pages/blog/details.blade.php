                  ...
                  <div class="col-xl-12">
                      <div class="card custom-card">
                          <div class="card-body pb-0">
                              <a href="javascript:void(0);">
                                  <img src="{{ asset('') }}/assets/images/media/blog/19.jpg" class="card-img rounded blog-details-img" alt="...">
                              </a>
                          ...
                          <div class="card-body p-0">
                              <ul class="list-group list-group-flush">
                                  <li class="list-group-item">
                                      <div class="d-flex gap-3 flex-wrap align-items-center">
                                          <span class="avatar avatar-xl">
                                              <img src="{{ asset('') }}/assets/images/media/blog/14.jpg" class="img-fluid" alt="...">
                                          </span>
                                          <div class="flex-fill">
                                  ...
                                  <li class="list-group-item">
                                      <div class="d-flex gap-3 flex-wrap align-items-center">
                                          <span class="avatar avatar-xl">
                                              <img src="{{ asset('') }}/assets/images/media/blog/15.jpg" class="img-fluid" alt="...">
                                          </span>
                                          <div class="flex-fill">
                                  ...
                                  <li class="list-group-item">
                                      <div class="d-flex gap-3 flex-wrap align-items-center">
                                          <span class="avatar avatar-xl">
                                              <img src="{{ asset('') }}/assets/images/media/blog/16.jpg" class="img-fluid" alt="...">
                                          </span>
                                          <div class="flex-fill">
                                  ...
                                  <li class="list-group-item">
                                      <div class="d-flex gap-3 flex-wrap align-items-center">
                                          <span class="avatar avatar-xl">
                                              <img src="{{ asset('') }}/assets/images/media/blog/17.jpg" class="img-fluid" alt="...">
                                          </span>
                                          <div class="flex-fill">
                          ...
                          <div class="card-body">
                              <div class="row gy-3">
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-48.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-48.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-49.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-49.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-50.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-50.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-51.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-51.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-52.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-52.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-53.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-53.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-54.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-54.jpg" alt="image" >
                                      </a>
                                  </div>
                                  <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                      <a href="{{ asset('') }}/assets/images/media/media-55.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                          <img src="{{ asset('') }}/assets/images/media/media-55.jpg" alt="image" >
                                      </a>
                                  </div>
                              </div>
                          </div>
