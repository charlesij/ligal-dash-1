...
<body class="authenticationcover-background bg-primary-transparent position-relative" id="particles-js">
    ...
    <!-- End Switcher -->
        ...
        <div class="d-flex justify-content-center align-items-center authentication">
              ...
              <div class="row  authentication-cover-main mx-0 border rounded bg-white">
                                ...
                                <div class="col-xl-10">
                                  <div class="rounded bg-white-transparent authentication-sub-content">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <img src="{{ asset('') }}/assets/images/media/lock.png" alt="img" width="100%">
                                    </div>
                  ...
                  <div class="col-xxl-6 col-xl-7">
                      <div class="row justify-content-center align-items-center h-100">
                          <div class="col-xxl-8 col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="card custom-card shadow-none my-auto">
                                  <div class="card-body p-5">
                                     ...
                                     <p class="mb-0 text-muted fw-normal text-center">Hello Charles !</p>
                                     <div class="row gy-3">
                                        <div class="col-xl-12">
                                    ...
                                    <div class="col-xl-12 d-grid mt-3">
                                        <a href="index.html" class="btn btn-primary btn-lg">Unlock</a>
                                    </div>
