...
<head>
    ...
    <title> Lintas Inovasi Global | Sign Up </title>
                    ...
                    <div class="card-body p-0">
                        <div class="p-5">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <div class="position-relative">
                                        <input type="email" class="form-control form-control-lg" id="signup-firstname"
                                ...
                                <div class="col-xl-12">
                                    <label for="signup-confirmpassword" class="form-label text-default">Confirm
                                        Password</label>
                                    <div class="position-relative">
                                        <input type="password" class="form-control form-control-lg" id="signup-confirmpassword"
                                            placeholder="Confirm Password">
                                        <a href="javascript:void(0);" class="show-password-button text-muted"
                                            onclick="createpassword('signup-confirmpassword',this)" id="button-addon3"><i
                                                class="ri-eye-off-line align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mb-3">
                                <p class="text-muted mt-3 mb-0">Already have an account? <a href="sign-in-basic.html"
