...
<head>
    ...
    <title> Lintas Inovasi Global | Reset Password </title>
              ...
              <div class="row  authentication-cover-main mx-0 border rounded bg-white">
                  ...
                  <div class="col-xxl-6 col-xl-7">
                      <div class="row justify-content-center align-items-center h-100">
                          <div class="col-xxl-8 col-xl-9 col-lg-10 col-md-10 col-sm-12 col-12">
                              <div class="card custom-card shadow-none my-auto">
                                  <div class="card-body p-5">
                                    ...
                                    <div class="d-grid mt-4">
                                        <a href="sign-in-basic.html" class="btn btn-primary btn-lg">Create</a>
                                    </div>
