...
<head>
    ...
    <title> Lintas Inovasi Global | Two Step Verification </title>
                          ...
                          <div class="col-xxl-8 col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="card custom-card shadow-none my-auto">
                                  <div class="card-body p-5">
                                     ...
                                     <p class="mb-4 text-muted fw-normal text-center">Enter the 4 digit code sent to the email Id.</p>
                                     <div class="row gy-3">
                                        ...
                                        <div class="col-xl-12 d-grid mt-3">
                                            <a href="index.html" class="btn btn-primary btn-lg">Verify</a>
                                        </div>
                                    </div>
