...
<div class="main-content app-content">
  <div class="container-fluid">
      ...
      <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
          <div>
              <h1 class="page-title fw-medium fs-18 mb-2">Currency Exchange</h1>
              <div class="">
                  <nav>
                      ...
                      <div class="container">
                          ...
                          <div class="row justify-content-center align-items-center">
                              ...
                              <div class="p-4 mb-4 rounded currency-exchange-area">
                                        <div class="row gy-3">
                                          <div class="col-xl-5">
                                              <p class="mb-2 fs-14 text-fixed-white fw-semibold">From :</p>
                                              <div class="input-group d-flex flex-nowrap">
                                                  <input type="text" class="form-control py-0 crypto-buy-sell-input" aria-label="crypto buy select" placeholder="Enter Amount">
                                                  <select class="form-control" data-trigger name="Vacancies">
                                                      ...
                                                      <option value="Choice 5">ADA</option>
                                              ...
                                              <p class="mt-2 mb-0 text-fixed-white op-8">1BTC= 0.85645638USD</p>
                                          </div>
                                          <div class="col-xl-2 justify-content-center d-flex align-items-center">
                                              <span class="p-1 border border-white border-opacity-10 rounded-pill">
                                                  <button class="btn btn-icon rounded-pill btn-secondary"><i class="ri-arrow-left-right-line"></i></button>
                                              </span>
                                          </div>
                                          <div class="col-xl-5">
                                              <p class="mb-2 fs-14 text-fixed-white fw-semibold">To :</p>
                                              <div class="input-group d-flex flex-nowrap">
                                                  <input type="text" class="form-control py-0" value="1350.93" placeholder="Exchange Amount">
                                                    <select class="form-control" data-trigger name="Vacancies">
                                              ...
                                              <p class="mt-2 mb-0 text-fixed-white op-8">We Use Mindmarket Rates<i class="ri-error-warning-line ms-1"></i></p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  ...
                                  <h6 class="fw-medium mb-0">Bitcoin - BTC</h6>
                              </div>
                          ...
                          <div class="text-end">
                              ...
                              <span class="d-block text-success fw-medium">$30.29</span>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  ...
                                  <h6 class="fw-medium mb-0">Etherium - ETH</h6>
                              </div>
                          ...
                          <div class="text-end">
                              ...
                              <span class="d-block text-success fw-medium">$2,283.73</span>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-rounded avatar-xs">
                                          <img src="{{ asset('') }}/assets/images/crypto-currencies/square-color/Dash.svg" alt="">
                                      </span>
                                  </div>
                                  <h6 class="fw-medium mb-0">Dash - DASH</h6>
                              </div>
                              <span class="fs-25 d-flex align-items-center">17.67% <span class="fs-12 text-warning op-7 ms-2">+1.30<i class="ti ti-arrow-big-up-line ms-1 d-inline-flex"></i></span></span>
                          </div>
                          <div class="text-end">
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-rounded avatar-xs">
                                          <img src="{{ asset('') }}/assets/images/crypto-currencies/square-color/Litecoin.svg" alt="">
                                      </span>
                                  </div>
                                  <h6 class="fw-medium mb-0">Litecoin - LTC</h6>
                              </div>
                              <span class="fs-25 d-flex align-items-center">17.67% <span class="fs-12 text-warning op-7 ms-2">+1.30<i class="ti ti-arrow-big-up-line ms-1 d-inline-flex"></i></span></span>
                          </div>
                          <div class="text-end">
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  ...
                                  <h6 class="fw-medium mb-0">Ripple - XRS</h6>
                              </div>
                              <span class="fs-25 d-flex align-items-center">17.67% <span class="fs-12 text-warning op-7 ms-2">+1.30<i class="ti ti-arrow-big-up-line ms-1 d-inline-flex"></i></span></span>
                          </div>
                          <div class="text-end">
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-rounded avatar-xs">
                                          <img src="{{ asset('') }}/assets/images/crypto-currencies/square-color/Golem.svg" alt="">
                                      </span>
                                  </div>
                                  <h6 class="fw-medium mb-0">Golem - GLM</h6>
                              </div>
                              <span class="fs-25 d-flex align-items-center">17.67% <span class="fs-12 text-warning op-7 ms-2">+1.30<i class="ti ti-arrow-big-up-line ms-1 d-inline-flex"></i></span></span>
                          </div>
                          <div class="text-end">
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-rounded avatar-xs">
                                          <img src="{{ asset('') }}/assets/images/crypto-currencies/square-color/Monero.svg" alt="">
                                      </span>
                                  </div>
                      ...
                      <div class="d-flex align-items-top justify-content-between mb-3 flex-wrap">
                          <div>
                              <div class="d-flex align-items-center gap-2 mb-3">
                                  <div class="lh-1">
                                      <span class="avatar avatar-rounded avatar-xs">
                                          <img src="{{ asset('') }}/assets/images/crypto-currencies/square-color/EOS.svg" alt="">
                                      </span>
                                  </div>
