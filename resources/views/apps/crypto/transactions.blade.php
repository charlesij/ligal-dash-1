                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Bitcoin.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Dash.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Euro.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Ethereum.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Golem.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/litecoin.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Ripple.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/monero.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Zcash.svg" alt="">
                                              </span>
                                  ...
                                  <tr>
                                      ...
                                      <td class="border-bottom-0">
                                          <div class="d-flex align-items-center gap-2">
                                              <span class="avatar avatar-xs avatar-rounded">
                                                  <img src="{{ asset('') }}/assets/images/crypto-currencies/regular/Decred.svg" alt="">
                                              </span>
