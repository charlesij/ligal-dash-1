                      ...
                      <div class="table-responsive">
                          <table class="table text-nowrap">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                              ...
                                              <div class="me-3">
                                                  <span class="avatar avatar-xxl p-1 border">
                                                      <span
                                                          ...
                                                          <img src="{{ asset('') }}/assets/images/ecommerce/png/14.png"
                                                              alt="">
                                                      </span>
                                                  </span>
                                              </div>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="dropdown">
                                                  <a href="javascript:void(0);" class="p-2 fs-14 text-muted"
                                                      data-bs-toggle="dropdown" aria-expanded="false"> Orange
                                                      <i
                                                          class="ri-arrow-down-s-line align-middle d-inline-block"></i>
                                                  </a>
                                                  <ul class="dropdown-menu" role="menu">
                                      ...
                                      <td class="product-quantity-container">
                                          <div class="input-group border rounded flex-nowrap">
                                              <div class="input-group p-1 rounded bg-light flex-nowrap">
                                                  ...
                                                  <input type="text"
                                                      class="form-control form-control-sm border-0 text-center bg-light w-100"
                                                      aria-label="quantity" id="product-quantity2" value="2">
                                                  <button
                                                      class="btn btn-icon bg-white border input-group-text flex-fill product-quantity-plus"><i
                                                          class="ri-add-line"></i></button>
                                              </div>
                                  ...
                                  <tr>
                                      <td class="ps-4"><input class="form-check-input" type="checkbox"
                                              id="checkboxNoLabeljob3" value="" aria-label="..."></td>
                                      <td>
                                          <div class="d-flex align-items-center">
                                              <div class="me-3">
                                                  <span class="avatar avatar-xxl p-1 border">
                                                      <span
                                                          ...
                                                          <img src="{{ asset('') }}/assets/images/ecommerce/png/33.png"
                                                              alt="">
                                                      </span>
                                                  </span>
                                              </div>
                                              <div>
                                                  <div class="mb-1 fs-14 fw-semibold">
                                                      <a href="javascript:void(0);">Classic oriental fragrance
                                                          Perfume</a>
                                                  </div>
                                                  <div class="mb-1">
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="dropdown">
                                                  <a href="javascript:void(0);" class="p-2 fs-14 text-muted"
                                                      data-bs-toggle="dropdown" aria-expanded="false"> Pink <i
                                                          class="ri-arrow-down-s-line align-middle d-inline-block"></i>
                                                  </a>
                                                  <ul class="dropdown-menu" role="menu">
                                                      <li><a class="dropdown-item"
                                      ...
                                      <td class="product-quantity-container">
                                          <div class="input-group border rounded flex-nowrap">
                                              <div class="input-group p-1 rounded bg-light flex-nowrap">
                                                  ...
                                                  <input type="text"
                                                      class="form-control form-control-sm border-0 text-center bg-light w-100"
                                                      aria-label="quantity" id="product-quantity3" value="2">
                                                  <button
                                                      class="btn btn-icon bg-white border input-group-text flex-fill product-quantity-plus"><i
                                                          class="ri-add-line"></i></button>
                                              </div>
                                  ...
                                  <tr>
                                      <td class="ps-4"><input class="form-check-input" type="checkbox"
                                              id="checkboxNoLabeljob4" value="" aria-label="..."></td>
                                      <td>
                                          <div class="d-flex align-items-center">
                                              <div class="me-3">
                                                  <span class="avatar avatar-xxl p-1 border">
                                                      <span class="avatar avatar-xl p-1 bg-pink-transparent">
                                                          <img src="{{ asset('') }}/assets/images/ecommerce/png/31.png"
                                                              alt="">
                                                      </span>
                                                  </span>
                                              </div>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="dropdown">
                                                  <a href="javascript:void(0);" class="p-2 fs-14 text-muted"
                                                      data-bs-toggle="dropdown" aria-expanded="false">Green<i
                                                          class="ri-arrow-down-s-line align-middle d-inline-block"></i>
                                                  </a>
                                                  <ul class="dropdown-menu" role="menu">
                                                      <li><a class="dropdown-item"
                                      ...
                                      <td class="product-quantity-container">
                                          <div class="input-group border rounded flex-nowrap">
                                              <div class="input-group p-1 rounded bg-light flex-nowrap">
                                                  ...
                                                  <input type="text"
                                                      class="form-control form-control-sm border-0 text-center bg-light w-100"
                                                      aria-label="quantity" id="product-quantity4" value="2">
                                                  <button
                                                      class="btn btn-icon bg-white border input-group-text flex-fill product-quantity-plus"><i
                                                          class="ri-add-line"></i></button>
                                              </div>
                                  ...
                                  <tr>
                                              ...
                                              <div class="me-3">
                                                  <span class="avatar avatar-xxl p-1 border">
                                                      <span
                                                          ...
                                                          <img src="{{ asset('') }}/assets/images/ecommerce/png/37.png"
                                                              alt="">
                                                      </span>
                                                  </span>
                                              </div>
                                      ...
                                      <td>
                                          <div class="d-flex align-items-center">
                                              ...
                                              <div class="dropdown">
                                                  <a href="javascript:void(0);" class="p-2 fs-14 text-muted"
                                                      data-bs-toggle="dropdown" aria-expanded="false">Black<i
                                                          class="ri-arrow-down-s-line align-middle d-inline-block"></i>
                                                  </a>
                                                  <ul class="dropdown-menu" role="menu">
                                                      <li><a class="dropdown-item"
                                      ...
                                      <tbody>
                                          ...
                                          <tr class="">
                                              <td class=""><span class="fs-14">Delivery <span
                                                          class="fs-12 text-primary ms-1">(2 Items)</span></span>
                                              </td>
                                          ...
                                          <tr class="">
                                              <td class=""><span class="fs-14">Over All Discount</span>
                                              </td>
                                              <td class="text-end "> <span class="fs-14 fw-semibold">-
                                                      15%</span> </td>
                                          </tr>
                                          <tr class="">
                                              <td class=""><span class="fs-14">Shipping Charges</span></td>
                                          ...
                                          <tr class="border-top border-bottom">
                                              <td class=""><span class="fs-14 text-success">HAPPY2024</span>
                                              </td>
                                              <td class="text-end text-success"> <i
                                                      class="ri-checkbox-circle-line fs-18"></i> </td>
                                          </tr>
                                          <tr class="border-bottom">
                                              <td class=""><span class="fw-semibold fs-14">Total</span>
                                              </td>
                                              <td class="text-end "> <span
                                  ...
                                  <table class="table text-nowrap table-borderless border rounded mb-3">
                                      <tbody>
                                          ...
                                          <tr class="">
                                              ...
                                              <td class="text-end"> <span class="fs-14 fw-semibold"> 0 (Free)
                                                  </span> </td>
                                          </tr>
                                          <tr class="">
                                              <td class=""><span class="fs-14">Pickup Point <span
