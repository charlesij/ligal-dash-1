                          ...
                          <div class="swiper-wrapper d-sm-block d-flex">
                              <div class="swiper-slide w-sm-100 mb-4 p-2">
                                  <img class="img-fluid bg-primary-transparent p-1"
                                      src="{{ asset('/assets/images/ecommerce/png/5.png') }}" alt="img">
                              </div>
                              <div class="swiper-slide w-sm-100 mb-4 p-2">
                                  <img class="img-fluid bg-secondary-transparent p-1"
                                      src="{{ asset('/assets/images/ecommerce/png/4.png') }}" alt="img">
                              </div>
                              <div class="swiper-slide w-sm-100 mb-4 p-2">
                                  <img class="img-fluid bg-success-transparent p-1"
                                      src="{{ asset('/assets/images/ecommerce/png/3.png') }}" alt="img">
                              </div>
                              <div class="swiper-slide w-sm-100 mb-4 p-2">
                                  <img class="img-fluid bg-info-transparent p-1"
                                      src="{{ asset('/assets/images/ecommerce/png/2.png') }}" alt="img">
                              </div>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="swiper swiper-preview-details bg-white p-3 product-details-page">
                          <div class="swiper-wrapper">
                              <div class="swiper-slide" id="img-container">
                                  <img class="img-fluid bg-light" src="{{ asset('/assets/images/ecommerce/png/38.png') }}"
                                      alt="img">
                              </div>
                              <div class="swiper-slide image-container">
                                  <img class="img-fluid bg-light" src="{{ asset('/assets/images/ecommerce/png/39.png') }}"
                                      alt="img">
                              </div>
                              <div class="swiper-slide image-container">
                                  <img class="img-fluid bg-light" src="{{ asset('/assets/images/ecommerce/png/40.png') }}"
                                      alt="img">
                              </div>
                              <div class="swiper-slide image-container">
                                  <img class="img-fluid bg-light" src="{{ asset('/assets/images/ecommerce/png/41.png') }}"
                                      alt="img">
                              </div>
                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top p-2 border-bottom border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-primary-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/1.png') }}"
                                                      alt="img"
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top border-bottom p-2 border-block-end-dashed">
                                              ...
                                              <div class="img-box-2  bg-secondary-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/14.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top border-bottom p-2 border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-success-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/33.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top p-2 border-bottom border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-info-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/10.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top p-2 border-bottom border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-pink-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/31.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top p-2 border-bottom border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-warning-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/37.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top p-2 border-bottom border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-teal-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/35.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
                                  ...
                                  <div class="card custom-card card-style-2">
                                      <div class="card-body p-0">
                                          ...
                                          <div class="card-img-top border-bottom p-2 border-block-end-dashed">
                                              ...
                                              <div class="img-box-2 bg-danger-transparent"> <img src="{{ asset('/assets/images/ecommerce/png/36.png') }}"
                                                      alt="img"
                                                      class="scale-img img-fluid w-100  rounded">
                                              </div>
                                          </div>
