...
@section('content')
        ...
        <div class="main-content app-content">
          <div class="container-fluid">
              ...
              <div class="row">
                  <div class="col-xl-12">
                      <div class="swiper crypto-swiper swiper-basic swiper-initialized swiper-horizontal swiper-backface-hidden">
                          <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                              ...
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/binance-usd-busd-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                                          <div class="d-flex align-items-center mb-3 gap-2 justify-content-between">
                                              <div class="d-flex align-items-center gap-2">
                                                  <div class="lh-1 avatar avatar-lg bg-light p-2 avatar-rounded">
                              ...
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/cardano-ada-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                                          <div class="d-flex align-items-center mb-3 gap-2 justify-content-between">
                                              <div class="d-flex align-items-center gap-2">
                                                  <div class="lh-1 avatar avatar-lg bg-light p-2 avatar-rounded">
                              ...
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                                          <div class="d-flex align-items-center mb-3 gap-2 justify-content-between">
                                              <div class="d-flex align-items-center gap-2">
                                                  <div class="lh-1 avatar avatar-lg bg-light p-2 avatar-rounded">
                              ...
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                                          <div class="d-flex align-items-center mb-3 gap-2 justify-content-between">
                                              <div class="d-flex align-items-center gap-2">
                                                  <div class="lh-1 avatar avatar-lg bg-light p-2 avatar-rounded">
                              ...
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                                          <div class="d-flex align-items-center mb-3 gap-2 justify-content-between">
                                              <div class="d-flex align-items-center gap-2">
                                                  <div class="lh-1 avatar avatar-lg bg-light p-2 avatar-rounded">
                                                      <img src="../assets/images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg" alt="" class="w-auto">
                                                  </div>
                                                  <div>
                              ...
                              <div class="swiper-slide">
                                  <div class="card custom-card overflow-hidden">
                                      <div class="card-body">
                                          <div>
                                              <img src="../assets/images/crypto-currencies/crypto-icons/solana-sol-logo.svg" class="crypto-main-card-icon" alt="">
                                          </div>
                                          <div class="d-flex align-items-center mb-3 gap-2 justify-content-between">
                                              <div class="d-flex align-items-center gap-2">
                                                  <div class="lh-1 avatar avatar-lg bg-light p-2 avatar-rounded">
