                      ...
                      <ul class="list-unstyled watchlist-list">
                              ...
                              <div class="d-flex align-items-center gap-2">
                                  <div class="lh-1">
                                      <span class="avatar avatar-xs">
                                          <img src="../assets/images/media/apps/apple.png" alt="" class="invert-1">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li>    
                              <div class="d-flex align-items-center gap-2">
                                  <div class="lh-1">
                                      <span class="avatar avatar-xs">
                                          <img src="../assets/images/media/apps/google.png" alt="" class="invert-1">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li>    
                              <div class="d-flex align-items-center gap-2">
                                  <div class="lh-1">
                                      <span class="avatar avatar-xs">
                                          <img src="../assets/images/media/apps/microsoft.png" alt="" class="invert-1">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li>    
                              <div class="d-flex align-items-center gap-2">
                                  <div class="lh-1">
                                      <span class="avatar avatar-xs">
                                          <img src="../assets/images/media/apps/amazon.png" alt="" class="invert-1">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li>    
                              <div class="d-flex align-items-center gap-2">
                                  <div class="lh-1">
                                      <span class="avatar avatar-xs">
                                          <img src="../assets/images/media/apps/tesla.png" alt="" class="invert-1">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
                          ...
                          <li>    
                              <div class="d-flex align-items-center gap-2">
                                  <div class="lh-1">
                                      <span class="avatar avatar-xs">
                                          <img src="../assets/images/media/apps/facebook.png" alt="" class="invert-1">
                                      </span>
                                  </div>
                                  <div class="flex-fill">
