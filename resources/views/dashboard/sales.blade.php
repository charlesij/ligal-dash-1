	...
	<div class="main-content app-content">
		<div class="container-fluid">
			...
			<div class="d-flex align-items-center justify-content-between my-4 page-header-breadcrumb flex-wrap gap-2">
				<div>
					<p class="fw-semibold fs-20 mb-0">Welcome Back, Charles</p>
									...
									<div class="card-body p-0">
											<div class="table-responsive">
													<table class="table text-nowrap">
															<thead>
																	<tr>
																			<th scope="row" class="ps-4"><input class="form-check-input" type="checkbox" id="checkboxNoLabeljob1" value="" aria-label="{{ asset('') }}."></th>
															...
															<tbody>
																	...
																	<tr>
																			<td class="ps-4"><input class="form-check-input" type="checkbox" id="checkboxNoLabeljob4" value="" aria-label="{{ asset('') }}." checked=""></td>
																			<td>
																					<div class="d-flex">
																							<span class="avatar avatar-md bg-light"><img src="{{ asset('') }}/assets/images/ecommerce/png/31.png" class="" alt="{{ asset('') }}."></span>
																							<div class="ms-2">
																	...
																	<tr>
																			<td class="ps-4"><input class="form-check-input" type="checkbox" id="checkboxNoLabeljob5" value="" aria-label="{{ asset('') }}."></td>
																			<td>
																					<div class="d-flex">
																							<span class="avatar avatar-md bg-light"><img src="{{ asset('') }}/assets/images/ecommerce/png/14.png" class="" alt="{{ asset('') }}."></span>
																							<div class="ms-2">
																	...
																	<tr>
																			<td class="ps-4 border-bottom-0"><input class="form-check-input" type="checkbox" id="checkboxNoLabeljob7" value="" aria-label="{{ asset('') }}."></td>
																			<td class="border-bottom-0">
																					<div class="d-flex">
																							<span class="avatar avatar-md bg-light"><img src="{{ asset('') }}/assets/images/ecommerce/png/13.png" class="" alt="{{ asset('') }}."></span>
																							<div class="ms-2">
											...
											<ul class="list-unstyled visitors-browser-list">
															...
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">Chrome<span class="text-muted fs-13 ms-1">(Google LLC)</span></span>
													...
													<li>
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">Edge<span class="text-muted fs-13 ms-1 fw-normal">(Microsoft Corp)</span></span>
													...
													<li>
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">Firefox<span class="text-muted fs-13 ms-1 fw-normal">(Mozilla Corp)</span></span>
													...
													<li>
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">Safari<span class="text-muted fs-13 ms-1 fw-normal">(Apple Inc)</span></span>
													...
													<li>
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">UCBrowser<span class="text-muted fs-13 ms-1 fw-normal">(UCWeb)</span></span>
													...
													<li>
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">Opera<span class="text-muted fs-13 ms-1 fw-normal">(Opera Software AS)</span></span>
													...
													<li>
															<div class="d-flex align-items-center gap-2 flex-wrap">
																	...
																	<div class="flex-fill">
																			<div class="d-flex align-items-center justify-content-between mb-2 flex-wrap">
																					<span class="d-block fw-semibold d-inline-flex">Samsung Internet<span class="text-muted fs-13 ms-1 fw-normal">(Samsung)</span></span>
