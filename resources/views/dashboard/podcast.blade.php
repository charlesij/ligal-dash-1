                        ...
                        <div class="row gy-3 personal-favourite-contacts mb-0">
                                ...
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/1.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/2.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/3.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/4.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/5.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/6.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/7.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2">
                                    <div class="me-2">
                                        <span class="avatar avatar-lg bg-light p-2">
                                            <img alt="" src="../assets/images/podcast/8.png" class="rounded-0">
                                        </span>
                                    </div>
                                    <div class="flex-fill">
                ...
                <div class="row">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="../assets/images/podcast/11.jpg" alt="img" class="avatar avatar-xxl me-3">
                                    <div class="w-100">
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="../assets/images/podcast/12.jpg" alt="img" class="avatar avatar-xxl me-3">
                                    <div class="w-100">
                                        <div class="d-flex align-items-start justify-content-between mb-4">
                                            <div>
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="../assets/images/podcast/14.jpg" alt="img" class="avatar avatar-xxl me-3">
                                    <div class="w-100">
                                        <div class="d-flex align-items-start justify-content-between mb-4">
                                            <div>
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="../assets/images/podcast/13.jpg" alt="img" class="avatar avatar-xxl me-3">
                                    <div class="w-100">
                                        <div class="d-flex align-items-start justify-content-between mb-4">
                                            <div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            <span class="mb-3 podcast-playing-now">
                                <img src="../assets/images/podcast/15.jpg" alt="" class="w-100">
                            </span>
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <span class="avatar avatar-md"><img src="../assets/images/podcast/11.jpg" class="" alt="..."></span>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <span class="avatar avatar-md"><img src="../assets/images/podcast/12.jpg" class="" alt="..."></span>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <span class="avatar avatar-md"><img src="../assets/images/podcast/13.jpg" class="" alt="..."></span>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <span class="avatar avatar-md"><img src="../assets/images/podcast/14.jpg" class="" alt="..."></span>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <span class="avatar avatar-md"><img src="../assets/images/media/media-60.jpg" class="" alt="..."></span>
                                                <div>
